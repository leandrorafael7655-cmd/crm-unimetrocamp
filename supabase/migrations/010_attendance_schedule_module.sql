...
begin
  if tg_op = 'INSERT' then
    ...
    values(new.id,'insert',coalesce(new.updated_by,new.created_by,actor),to_jsonb(new));
    return new;
...
insert into public.attendance_settings(id,schedule_start_date) values (1,'2026-10-26')
...
('junior','Junior',1,true),('vanessa','Vanessa',2,true),('madu','Madu',3,true),('carla','Carla',4,true),
('adryeli','Adryeli',5,true),('ramon','Ramon',6,true),('consultor_7','Consultor 7',7,true),('consultor_8','Consultor 8',8,true)
...
(1,'room_early',1,'junior'),(1,'room_early',2,'vanessa'),(1,'room_late',1,'madu'),(1,'room_late',2,'carla'),
(1,'conversion_am_external_pm',1,'adryeli'),(1,'conversion_am_external_pm',2,'ramon'),(1,'external_am_conversion_pm',1,'consultor_7'),(1,'external_am_conversion_pm',2,'consultor_8'),(1,'saturday',1,'junior'),(1,'saturday',2,'vanessa'),
(2,'room_early',1,'consultor_7'),(2,'room_early',2,'consultor_8'),(2,'room_late',1,'junior'),(2,'room_late',2,'vanessa'),
(2,'conversion_am_external_pm',1,'madu'),(2,'conversion_am_external_pm',2,'carla'),(2,'external_am_conversion_pm',1,'adryeli'),(2,'external_am_conversion_pm',2,'ramon'),(2,'saturday',1,'madu'),(2,'saturday',2,'carla'),
(3,'room_early',1,'adryeli'),(3,'room_early',2,'ramon'),(3,'room_late',1,'consultor_7'),(3,'room_late',2,'consultor_8'),
(3,'conversion_am_external_pm',1,'junior'),(3,'conversion_am_external_pm',2,'vanessa'),(3,'external_am_conversion_pm',1,'madu'),(3,'external_am_conversion_pm',2,'carla'),(3,'saturday',1,'adryeli'),(3,'saturday',2,'ramon'),
(4,'room_early',1,'madu'),(4,'room_early',2,'carla'),(4,'room_late',1,'adryeli'),(4,'room_late',2,'ramon'),
(4,'conversion_am_external_pm',1,'consultor_7'),(4,'conversion_am_external_pm',2,'consultor_8'),(4,'external_am_conversion_pm',1,'junior'),(4,'external_am_conversion_pm',2,'vanessa'),(4,'saturday',1,'consultor_7'),(4,'saturday',2,'consultor_8')
